...
class TevatronTrainer(Trainer):
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        ...
        # # Import DSEModel here to avoid circular imports
        # try:
        #     from ..examples.dse.qwen.dse import DSEModel
        #     supported_classes = (EncoderModel, DSEModel)
        # except ImportError:
        #     # Fallback if DSEModel is not available
